#ifndef VIEW_CURSOR_3D_ENTITY_H
#define VIEW_CURSOR_3D_ENTITY_H

#include "Cursor3dConfig.h"
#include "../Camera/Camera3dService.h"

namespace graphique
{
    class Cursor3dEntity : public CursorEntity
    {
        protected:
