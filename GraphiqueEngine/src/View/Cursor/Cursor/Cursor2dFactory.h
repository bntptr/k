#ifndef VIEW_CURSOR_2D_FACTORY_H
#define VIEW_CURSOR_2D_FACTORY_H

#include "Cursor2dEntity.h"

namespace graphique
{
    class Cursor2dFactory
    {
        public:
            static ICursorEntity* createEntity(irr::IrrlichtDevice *device, IView *view) {
                ...
                return new Cursor2dEntity(device, view, keyMap);
            }
    };
} // graphique
